...
public class Model
{
  ...
  public Manufacturer addManufacturer(String name, String email,
      double phoneNumber) throws SQLException
  {
  ...
  public ArrayList<Double> getGenerationByTimePeriod(String startDate,
  ...
  public void registerEmployee(String CPR, String fName, String lNAme,
      String email, double phoneNo, String employmentDate, String password,
      Role role, Factory workPlace) throws SQLException
  {
    EmployeeDAO employeeDAO = EmployeeDAO.getInstance();
    employeeDAO.createEmployee(CPR, fName, lNAme, email, phoneNo,
        employmentDate, password, role, workPlace);
  }

  public ArrayList<PhotovoltaicPanel> getPvLogValues(String startTime,
      String endTime, Double sn) throws SQLException
  {
    PvPanelLogDAO pvPanelLogDAO = PvPanelLogDAO.getInstance();
    return pvPanelLogDAO.readValues(startTime, endTime, sn);
  }

  public ArrayList<ThermalPanel> getThLogValues(String startTime,
      String endTime, Double sn) throws SQLException
  {
